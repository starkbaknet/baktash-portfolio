export const skillsList = [
  [
    ...
    { name: "Rust", icon: "http://rust-lang.org/logos/rust-logo-512x512.png" },
    { name: "Dart", icon: "https://www.cdnlogo.com/logos/d/66/dart.svg" },
    {
      name: "HTML",
  ...
  [
    ...
    { name: "FastAPI", icon: "https://www.cdnlogo.com/logos/f/59/fastapi.svg" },
    { name: "Django", icon: "https://www.cdnlogo.com/logos/d/3/django.svg" },
    { name: "Flask", icon: "https://www.cdnlogo.com/logos/f/50/flask.svg" },
    {
      name: "Spring Boot",
